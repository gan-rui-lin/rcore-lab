...
impl NS16550aRaw {
    ...
    /// Write a byte, spinning until FIFO is ready.
...
impl<const BASE_ADDR: usize> NS16550a<BASE_ADDR> {
    /// Create a new NS16550a device wrapper.
    pub fn new() -> Self {
    ...
    /// Check whether the internal read buffer is empty.
